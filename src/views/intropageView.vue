<template>
    <div class="half">
       <div class="sign-in">
        <div class="img">
            <img src="https://i.postimg.cc/rspSRzHr/pexels-donald-tong-23475.jpg" alt="img" class="image">
        </div>
        <div class="sign-text">
    ...
    <div class="log">
        <div class="login-text">
            ...
            <div class="buttons">
                <router-link to="/login" class="link"><div class="button">Log In</div></router-link>
            </div>
        </div>
        <div class="image">
            <img src="https://i.postimg.cc/028r0b96/pexels-pratik-prasad-8401620.jpg" alt="img" class="image-2">
